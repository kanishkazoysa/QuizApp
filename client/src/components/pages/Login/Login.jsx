...
const Login = () => {
  return (
    ...
    <div className="flex flex-col items-center w-screen h-screen justify-center sm:bg-blue-100 md:bg-gradient-to-br lg:bg-gradient-to-br from-purple-100 to-blue-100 ">
      gimhan
