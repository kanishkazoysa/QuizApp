...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,</p>
    <p>Thank you for signing up Korean Acedemy! Your verification code is:</p>
    ...
    <p>Best regards,<br>Korean Acedemy Team</p>
  </div>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <p>Best regards,<br>Korean Acadamy Team</p>
  </div>
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
    <p>This is an automated message, please do not reply to this email.</p>
  </div>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <p>Best regards,<br>Korean Academy Team</p>
  </div>
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
    <p>This is an automated message, please do not reply to this email.</p>
  </div>
...
<body style="font-family: 'Inter', sans-serif; background: #E5E5E5;">
  <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="white">
    <tbody>
      <tr>
  ...
  <td style="padding: 0 24px; text-align: center">
    <img src="https://mailsend-email-assets.mailtrap.io/i4t6ryni44y15yawc71fs4am4u0r.jpg" alt="logo" style="max-width: 100px; max-height: 100px; text-align: center; padding-top: 10px;">
  </td>
</tr>
              <tr>
                <td style="padding:48px 0 30px 0; text-align: center; font-size: 28px; color: black;font-weight: bold">
                  Korean Academy
                </td>
              </tr>
              <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Thanks for choosing Korean Academy! We are happy to see you on board.
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Best regards, <br><strong>Korean Academy</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
